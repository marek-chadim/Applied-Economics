...
#         Content Courtsey of Thai T. Pham & Zanele Munyikwa     #
...
# Make sure the working directory is set to where the file 'socialneighbor.csv' is located.
# Inside RStudio, you can change the working directory by clicking on
#   Session > Set Working Directory > Choose Directory
# Alternatively, uncomment and modify the lines below.
# setwd('C:\path\to\correct\directory\')  # Windows
# setwd('/path/to/correct/directory')     # Mac / Linux
